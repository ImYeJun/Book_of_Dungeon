...
class Stage:
    def __init__(self,enemy_count = 5,stage_set_value = ["none",8,10,"none"]):    
        ...
        for i in range(1,enemy_count+1):
            ...
            self.enemy_list.append(Character(hp=50,name="enemy{}".format(i), img=enemy_value[0],type=enemy_value[1]))
...
########################################################################################################################
                    ...
                    screen.blit(self.enemy_list[k].object.img,self.enemy_list[k].object.rect)
                    screen_update()
