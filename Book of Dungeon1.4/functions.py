...
class StageSet:
    ...
    def stage_rebuild(self):
        ...
        txt011 = ScreenObject("txt","{}".format(self.skill01.name),txt_color=type_color,pos_x = self.skill01.img.pos_x,pos_y=375)
        txt012 = ScreenObject("txt","{} ~ {}".format(self.skill01.value01,self.skill01.value02),txt_color=Background,pos_x = self.skill01.img.pos_x,pos_y=420)
        txt013 = ScreenObject("txt","{}".format(self.skill01.txt),txt_color=Background,pos_x = self.skill01.img.pos_x,pos_y=465)
        ...
        txt021 = ScreenObject("txt","{}".format(self.skill02.name),txt_color=type_color,pos_x = self.skill02.img.pos_x,pos_y=835)
        txt022 = ScreenObject("txt","{} ~ {}".format(self.skill02.value01,self.skill01.value02),txt_color=Background,pos_x = self.skill02.img.pos_x,pos_y=880)
        txt023 = ScreenObject("txt","{}".format(self.skill02.txt),txt_color=Background,pos_x = self.skill02.img.pos_x,pos_y=925)

        screen.blit(txt011.txt,txt011.rect)
        screen.blit(txt012.txt,txt012.rect)
        screen.blit(txt013.txt,txt013.rect)
        screen.blit(txt021.txt,txt021.rect)
        screen.blit(txt022.txt,txt022.rect)
        screen.blit(txt023.txt,txt023.rect)
