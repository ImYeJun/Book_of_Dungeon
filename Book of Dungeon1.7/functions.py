...
########################################################################################################################
                    ...
                    def fire_defense():
                        enemy_type=self.enemy_list[k].type
                        if enemy_type=="fire":
                            self.enemy_list[k].hp=self.enemy_list[k].hp-30
                        else:
                            self.prota.hp=self.prota.hp-random.randint(5,10)
                    ...
                    def dendro_defense():
                        enemy_type=self.enemy_list[k].type
                        if enemy_type=="dendro":
                            self.enemy_list[k].hp=self.enemy_list[k].hp-30
                        else:
                            self.prota.hp=self.prota.hp-random.randint(5,10)

                    print(self.enemy_list[k].type)
                    ...
                    while self.enemy_list[k].hp >= 0:
                        ...
                        pygame.draw.rect(screen, Red, (635, 735, 160, 110),5)
                        pygame.draw.rect(screen, Green, (715, 845, 160, 110),5)
                        pygame.draw.rect(screen, Blue, (795, 735, 160, 110),5)
                        ...
                        #hp1 = font_01.render("HP:"+str(self.enemy_list[k].hp),True, (255,0,0))
                        ...
                        #hp2 = font_01.render("HP:"+str(self.prota.hp),True, (255,0,0))
        ...
        for k in [self.prota.skill_01,self.prota.skill_02]:
            if k.name == "explosion":
                ...
                def explosion():
                    ...
                    webbrowser.open("https://www.youtube.com/watch?v=T-4wu280zC4")
